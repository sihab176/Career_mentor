...
export default function StatsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen bg-linear-to-b from-black/92 to-gray-900 py-20 px-4 flex items-center overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-blue-600 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-cyan-500 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
            ...
            return (
              ...
              >
                <div className="relative h-full">
                  {/* Glow effect */}
                  <div className={`absolute inset-0 bg-linear-to-r  opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500`} />
                  ...
                  <div className="relative  backdrop-blur-sm   p-8 text-center transition-all duration-500 hover:border-cyan-500/50 hover:transform hover:scale-105">
                    ...
                    {/* Value */}
                    <h3 className={`text-5xl md:text-6xl font-bold mb-4 text-transparent bg-clip-text bg-linear-to-r ${stat.color}`}>
                      {stat.value}
                    </h3>
