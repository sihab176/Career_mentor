...
const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      id: 1,
      quote: "I was skeptical about AI career tools, but CareerAI delivered. My resume score went from 54 to 91, and I landed my dream job within a month.",
    ...
    {
      id: 2,
      quote: "The AI-powered resume optimization was a game changer. I received interview calls from 5 Fortune 500 companies within two weeks of using CareerAI.",
      name: "Michael Chen",
    ...
    {
      id: 3,
      quote: "CareerAI helped me transition from teaching to tech. The personalized career guidance and resume building tools were exactly what I needed to make the switch.",
      name: "Sarah Johnson",
    ...
    {
      id: 4,
      quote: "I've used many career tools before, but none come close to CareerAI. The insights were spot-on and helped me negotiate a 40% salary increase.",
      name: "David Park",
  ...
  return (
    <section className="relative min-h-screen bg-black/94 py-20 px-4 flex items-center">
          ...
          <div className="bg-linear-to-br from-gray-900/80 to-gray-800/40 backdrop-blur-sm border border-gray-800/50 rounded-3xl p-5 md:p-6 min-h-[300px] flex flex-col justify-between transition-all duration-500">
            ...
            <div className={`flex-1 transition-opacity duration-500 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}>
              ...
              <div className="flex items-center gap-4">
                <div className={`w-14 h-14 rounded-full ${testimonials[currentSlide].color} flex items-center justify-center text-white text-xl font-bold`}>
