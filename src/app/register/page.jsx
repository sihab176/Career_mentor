...
const RegisterPage = () => {
  ...
  return (
    <section className="flex justify-center items-center bg-gray-100 h-dvh">
      <div className="w-full max-w-md px-8 py-18  space-y-3  border-6 border-white  bg-white/60    shadow-2xl  ">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-black">
          ...
          <button
            className="block w-full p-3 text-center rounded-sm bg-primary text-white btn border-none"
